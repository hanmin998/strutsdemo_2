...
public class selectRecoverMuddyAction extends ActionSupport{
	User user=new User();
	...
	public String execute() throws Exception {
		...
		if(t!=0){
			userList=operate.selectRecoverMuddy(selectType, condition,useUser.getUserId());
			return "recoverMuddyUser";
		}
		else
